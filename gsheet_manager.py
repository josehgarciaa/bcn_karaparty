...
class SheetRequestManager(GoogleSheetManager):
    ...
    def get_requests(self):
        ...
        records = self.sheet.get_all_records()
        return [ [record["Canta"], record["Autor/Anime"], record["Titulo"], record["Link de Youtube"]] for record in records ]    
...
class SheetAuthorizedUsersManager(GoogleSheetManager):
    ...
    def get_usernames(self):
        ...
        return [ record["Nombre"] for i,record in enumerate(records) ] 
